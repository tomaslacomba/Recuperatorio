...
{
    private int numeroCliente; private string nombre; private List vehiculos;
...
{
    private string marca; private string modelo; private int año; private List trabajos;
...
{
    private string descripcion; private TipoReparacion tipo; private double costo; private Mecánico mecanicoAsignado;
...
{
    private string nombre; private TipoReparacion especialidad;
...
{
    private List clientes; private List<Mecánico> mecanicos;
